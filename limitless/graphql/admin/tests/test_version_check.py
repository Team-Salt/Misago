...
def test_version_check_query_returns_error_if_limitless_version_is_unreleased(
    admin_graphql_client, mocker
):
    mocker.patch("limitless.graphql.admin.versioncheck.__released__", False)
...
def test_version_check_query_returns_success_if_site_is_updated(
    ...
    mocker.patch("limitless.graphql.admin.versioncheck.__released__", True)
