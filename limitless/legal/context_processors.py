...
def legal_links(request):
    ...
    if terms_of_service:
        ...
        if terms_of_service["link"]:
            ...
            legal_context["TERMS_OF_SERVICE_URL"] = reverse("limitless:terms-of-service")
    ...
    if privacy_policy:
        ...
        if privacy_policy["link"]:
            ...
            legal_context["PRIVACY_POLICY_URL"] = reverse("limitless:privacy-policy")
    ...
    if required_agreement:
        request.frontend_context["REQUIRED_AGREEMENT_API"] = reverse(
            "limitless:api:submit-agreement", kwargs={"pk": required_agreement.pk}
        )

        legal_context["limitless_agreement"] = {
