...
def create_default_categories_roles(apps, schema_editor):
    CategoryRole = apps.get_model("limitless_categories", "CategoryRole")

    CategoryRole.objects.create(
        name=_("See only"),
        permissions={
            # categories perms
            "limitless.categories.permissions": {"can_see": 1, "can_browse": 0}
        },
    )
    ...
    read_only = CategoryRole.objects.create(
        ...
        permissions={
            # categories perms
            "limitless.categories.permissions": {"can_see": 1, "can_browse": 1},
            # threads perms
    ...
    Category = apps.get_model("limitless_categories", "Category")
    Role = apps.get_model("limitless_acl", "Role")
    RoleCategoryACL = apps.get_model("limitless_categories", "RoleCategoryACL")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("limitless_categories", "0002_default_categories"),
