...
class CategoryRoleAdmin(generic.AdminBaseMixin):
    root_link = "limitless:admin:permissions:categories:index"
    model = CategoryRole
    templates_dir = "limitless/admin/categoryroles"
...
CategoriesList.add_item_action(
    name=_("Change permissions"), link="limitless:admin:categories:permissions"
)
...
RolesList.add_item_action(
    name=_("Categories permissions"), link="limitless:admin:permissions:categories"
)
