...
import limitless.threads.models.attachment
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("limitless_categories", "0001_initial"),
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="limitless_categories.Category",
                    ),
                ),
                (
                    "last_editor",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="limitless_threads.ThreadParticipant",
                to=settings.AUTH_USER_MODEL,
            ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="limitless_threads.Thread"
            ),
            preserve_default=True,
        ),
        migrations.AddField(
            ...
            fields=[
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        blank=True,
                        null=True,
                        upload_to=limitless.threads.models.attachment.upload_to,
                    ),
                ),
                (
                    "image",
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE,
                to="limitless_threads.AttachmentType",
            ),
        ),
        migrations.AddField(
            model_name="attachment",
        ...
        migrations.AddField(
            ...
            name="post",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.CASCADE, to="limitless_threads.Post"
            ),
        ),
        migrations.AddField(
            model_name="postlike",
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                ...
                through="limitless_threads.PostLike",
                to=settings.AUTH_USER_MODEL,
            ),
        ),
    ]
