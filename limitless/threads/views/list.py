...
class ForumThreadsList(ThreadsList):
    ...
    template_name = "limitless/threadslist/threads.html"

    def get_default_frontend_context(self):
        return {"MERGE_THREADS_API": reverse("limitless:api:thread-merge")}


class CategoryThreadsList(ForumThreadsList):
    category = ThreadsCategory

    template_name = "limitless/threadslist/category.html"
...
class PrivateThreadsList(ThreadsList):
    ...
    template_name = "limitless/threadslist/private_threads.html"
