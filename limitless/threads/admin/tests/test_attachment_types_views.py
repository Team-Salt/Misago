...
class AttachmentTypeAdminViewsTests(AdminTestCase):
    def setUp(self):
        super().setUp()
        self.admin_link = reverse("limitless:admin:settings:attachment-types:index")

    def test_link_registered(self):
        """admin nav contains attachment types link"""
        response = self.client.get(reverse("limitless:admin:settings:index"))
    ...
    def test_new_view(self):
        ...
        form_link = reverse("limitless:admin:settings:attachment-types:new")
    ...
    def test_edit_view(self):
        ...
        self.client.post(
            reverse("limitless:admin:settings:attachment-types:new"),
            data={
                "name": "Test type",
                "extensions": ".test",
                "size_limit": 0,
        ...
        form_link = reverse(
            "limitless:admin:settings:attachment-types:edit", kwargs={"pk": test_type.pk}
        )
    ...
    def test_delete_view(self):
        ...
        action_link = reverse(
            "limitless:admin:settings:attachment-types:delete", kwargs={"pk": test_type.pk}
        )
