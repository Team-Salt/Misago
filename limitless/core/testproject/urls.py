...
# Setup Django admin to work with LimitLess auth
...
urlpatterns = [
    ...
    url(r"^forum/", include("limitless.urls", namespace="limitless")),
    ...
    url(r"^forum/test-banned/$", views.raise_limitless_banned, name="raise-limitless-banned"),
    url(r"^forum/test-403/$", views.raise_limitless_403, name="raise-limitless-403"),
    url(r"^forum/test-404/$", views.raise_limitless_404, name="raise-limitless-404"),
    url(r"^forum/test-405/$", views.raise_limitless_405, name="raise-limitless-405"),
    url(
