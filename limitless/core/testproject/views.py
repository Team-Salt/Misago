...
def raise_limitless_banned(request):
    ban = Ban(user_message="Banned for test!")
    raise Banned(ban)


def raise_limitless_403(request):
    raise PermissionDenied("LimitLess 403")


def raise_limitless_404(request):
    raise Http404("LimitLess 404")


def raise_limitless_405(request):
