...
class AjaxError(Exception):
    """You've tried to do something over AJAX but limitless blurped"""
...
class SocialAuthFailed(AuthException):
    """Exception used to return error messages from LimitLess's social auth to user."""
...
class SocialAuthBanned(AuthException):
    """Exception used to return ban message from LimitLess's social auth to user."""
