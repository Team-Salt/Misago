...
def create_default_roles(apps, schema_editor):
    ...
    Role.objects.create(
        ...
        permissions={
            ...
            # search
            "limitless.search.permissions": {"can_search": 1},
        },
    )
    ...
    Role.objects.create(
        ...
        permissions={
            # rename users
            "limitless.users.permissions.moderation": {"can_rename_users": 1}
        },
    )
    ...
    Role.objects.create(
        ...
        permissions={
            # ban users
            "limitless.users.permissions.profiles": {"can_see_ban_details": 1},
            "limitless.users.permissions.moderation": {
                "can_ban_users": 1,
                "max_ban_length": 14,
                "can_lift_bans": 1,
    ...
    Role.objects.create(
        ...
        permissions={
            # profiles
            "limitless.users.permissions.profiles": {"can_be_blocked": 0}
        },
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [("limitless_acl", "0002_acl_version_tracker")]
