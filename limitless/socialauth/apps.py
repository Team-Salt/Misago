...
class LimitLessSocialAuthConfig(AppConfig):
    name = "limitless.socialauth"
    label = "limitless_socialauth"
    verbose_name = "LimitLess Social Auth"
    ...
    def ready(self):
        ...
        providers.add(
            ...
            admin_template="limitless/admin/socialauth/form.html",
        )
        providers.add(
            provider="github",
            name="GitHub",
