...
VERSION_CHECK_CACHE_KEY = "limitless_version_check"
...
def admin_index(request):
    ...
    return render(
        request,
        "limitless/admin/dashboard/index.html",
        {"totals": totals, "checks": checks},
    )


def check_cache():
    cache.set("limitless_cache_test", "ok")
    return {"is_ok": cache.get("limitless_cache_test") == "ok"}
