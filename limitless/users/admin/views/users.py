...
class UserAdmin(generic.AdminBaseMixin):
    root_link = "limitless:admin:users:index"
    templates_dir = "limitless/admin/users"
    model = User
...
class UsersList(UserAdmin, generic.ListView):
    ...
    def action_activate(self, request, users):
        ...
        if not inactive_users:
            ...
            mail_users(
                inactive_users,
                mail_subject,
                "limitless/emails/activation/by_admin",
    ...
    def action_ban(
        ...
        return self.render(
            ...
            template_name="limitless/admin/users/ban.html",
        )
...
class NewUser(UserAdmin, generic.ModelFormView):
    ...
    def handle_form(self, form, request, target):
        ...
        return redirect("limitless:admin:users:edit", pk=new_user.pk)
