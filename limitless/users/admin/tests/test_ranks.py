...
class RankAdminTests(AdminTestCase):
    def test_link_registered(self):
        ...
        response = self.client.get(reverse("limitless:admin:users:index"))

        response = self.client.get(response["location"])
        self.assertContains(response, reverse("limitless:admin:ranks:index"))

    def test_list_view(self):
        """ranks list view returns 200"""
        response = self.client.get(reverse("limitless:admin:ranks:index"))
    ...
    def test_new_view(self):
        ...
        response = self.client.get(reverse("limitless:admin:ranks:new"))
        self.assertEqual(response.status_code, 200)

        response = self.client.post(
            reverse("limitless:admin:ranks:new"),
            data={
                "name": "Test Rank",
    ...
    def test_edit_view(self):
        ...
        response = self.client.get(
            reverse("limitless:admin:ranks:edit", kwargs={"pk": test_rank.pk})
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_default_view(self):
        ...
        response = self.client.post(
            reverse("limitless:admin:ranks:default", kwargs={"pk": test_rank.pk})
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_move_up_view(self):
        ...
        response = self.client.post(
            reverse("limitless:admin:ranks:up", kwargs={"pk": test_rank.pk})
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_move_down_view(self):
        ...
        response = self.client.post(
            reverse("limitless:admin:ranks:down", kwargs={"pk": test_rank.pk})
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_users_view(self):
        ...
        response = self.client.get(
            reverse("limitless:admin:ranks:users", kwargs={"pk": test_rank.pk})
        )
        self.assertEqual(response.status_code, 302)
    ...
    def test_delete_view(self):
        ...
        response = self.client.post(
            reverse("limitless:admin:ranks:delete", kwargs={"pk": test_rank.pk})
        )
        self.assertEqual(response.status_code, 302)

        self.client.get(reverse("limitless:admin:ranks:index"))
        response = self.client.get(reverse("limitless:admin:ranks:index"))
        self.assertEqual(response.status_code, 200)
