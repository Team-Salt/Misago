...
class UserProfileViewsTests(AuthenticatedUserTestCase):
    ...
    def test_outdated_slugs(self):
        ...
        response = self.client.get(
            reverse("limitless:user-posts", kwargs={"slug": "baww", "pk": self.user.pk})
        )
    ...
    def test_user_posts_list(self):
        ...
        link = reverse("limitless:user-posts", kwargs=self.link_kwargs)
    ...
    def test_user_threads_list(self):
        ...
        link = reverse("limitless:user-threads", kwargs=self.link_kwargs)
    ...
    def test_user_followers(self):
        ...
        response = self.client.get(
            reverse("limitless:user-followers", kwargs=self.link_kwargs)
        )
    ...
    def test_user_follows(self):
        ...
        response = self.client.get(
            reverse("limitless:user-follows", kwargs=self.link_kwargs)
        )
    ...
    def test_user_details(self):
        ...
        response = self.client.get(
            reverse("limitless:user-details", kwargs=self.link_kwargs)
        )
    ...
    def test_username_history_list(self):
        ...
        response = self.client.get(
            reverse("limitless:username-history", kwargs=self.link_kwargs)
        )
        self.assertEqual(response.status_code, 200)
    ...
    def test_user_ban_details(self):
        ...
        with patch_user_acl({"can_see_ban_details": 0}):
            response = self.client.get(reverse("limitless:user-ban", kwargs=link_kwargs))
            self.assertEqual(response.status_code, 404)
