...
class UserDetailsApiTests(AuthenticatedUserTestCase):
    def test_api_has_no_showstoppers(self):
        ...
        response = self.client.get(
            reverse("limitless:api:user-details", kwargs={"pk": self.user.pk})
        )
    ...
    def test_other_user(self):
        ...
        api_link = reverse("limitless:api:user-details", kwargs={"pk": user.pk})
    ...
    def test_nonexistant_user(self):
        ...
        api_link = reverse("limitless:api:user-details", kwargs={"pk": self.user.pk + 123})
