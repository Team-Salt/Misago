...
class UserEditDetailsApiTests(AuthenticatedUserTestCase):
    def setUp(self):
        ...
        self.api_link = reverse(
            "limitless:api:user-edit-details", kwargs={"pk": self.user.pk}
        )
    ...
    def test_other_user(self):
        ...
        api_link = reverse("limitless:api:user-edit-details", kwargs={"pk": test_user.pk})
    ...
    def test_nonexistant_user(self):
        ...
        api_link = reverse(
            "limitless:api:user-edit-details", kwargs={"pk": self.user.pk + 123}
        )
