...
class AvatarServerTests(TestCase):
    ...
    def test_get_user_avatar_exact_size(self):
        ...
        avatar_url = reverse(
            "limitless:user-avatar", kwargs={"pk": self.user.pk, "size": 200}
        )
    ...
    def test_get_user_avatar_inexact_size(self):
        ...
        avatar_url = reverse(
            "limitless:user-avatar", kwargs={"pk": self.user.pk, "size": 250}
        )
    ...
    def test_get_notfound_user_avatar(self):
        ...
        avatar_url = reverse(
            "limitless:user-avatar", kwargs={"pk": self.user.pk + 1, "size": 150}
        )
        response = self.client.get(avatar_url)
    ...
    def test_blank_avatar_serving(self):
        ...
        response = self.client.get(reverse("limitless:blank-avatar"))
