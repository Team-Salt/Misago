...
class BioProfileFieldTests(AdminTestCase):
    def setUp(self):
        ...
        self.test_link = reverse("limitless:admin:users:edit", kwargs={"pk": self.user.pk})
    ...
    def test_admin_search_field(self):
        ...
        test_link = reverse("limitless:admin:users:index")
    ...
    def test_field_display(self):
        ...
        test_link = reverse(
            "limitless:user-details", kwargs={"pk": self.user.pk, "slug": self.user.slug}
        )
    ...
    def test_field_display_json(self):
        ...
        test_link = reverse("limitless:api:user-details", kwargs={"pk": self.user.pk})
    ...
    def test_api_returns_field_json(self):
        ...
        test_link = reverse("limitless:api:user-edit-details", kwargs={"pk": self.user.pk})
