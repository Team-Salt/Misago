...
class ProfileFieldsLoadTests(TestCase):
    ...
    def test_field_defines_fieldname(self):
            ...
            [
                {
                    "name": "Test",
                    "fields": [
                        "limitless.users.tests.testfiles.profilefields.NofieldnameField"
                    ],
                }
            ]
        )
        ...
        try:
            ...
            self.assertIn(
                "limitless.users.tests.testfiles.profilefields.NofieldnameField", error
            )
    ...
    def test_detect_repeated_imports(self):
        ...
        profilefields = ProfileFields(
            [
                {
                    "name": "Test",
                    "fields": ["limitless.users.profilefields.default.TwitterHandleField"],
                },
                {
                    "name": "Other test",
                    "fields": ["limitless.users.profilefields.default.TwitterHandleField"],
        ...
        try:
            ...
            self.assertIn(
                "limitless.users.profilefields.default.TwitterHandleField", error
            )
    ...
    def test_detect_repeated_fieldnames(self):
            ...
            [
                {
                    "name": "Test",
                    "fields": [
                        "limitless.users.tests.testfiles.profilefields.FieldnameField"
                    ],
                },
                {
                    "name": "Other test",
                    "fields": [
                        ...
                        "limitless.users.tests.testfiles.profilefields.RepeatedFieldnameField"
                    ],
                },
            ]
        )
        ...
        try:
            ...
            self.assertIn(
                "limitless.users.tests.testfiles.profilefields.FieldnameField", error
            )
            self.assertIn(
                "limitless.users.tests.testfiles.profilefields.RepeatedFieldnameField",
                error,
    ...
    def test_field_correct_field(self):
        ...
        field_path = "limitless.users.profilefields.default.RealNameField"
