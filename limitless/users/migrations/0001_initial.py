...
import limitless.users.avatars.store
...
class Migration(migrations.Migration):
    ...
    dependencies = [("auth", "0001_initial"), ("limitless_acl", "0001_initial")]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("roles", models.ManyToManyField(to="limitless_acl.Role")),
                (
                    "user_permissions",
                    models.ManyToManyField(
                        related_query_name="user",
                ...
                (
                    ...
                    models.ImageField(
                        max_length=255,
                        upload_to=limitless.users.avatars.store.upload_to,
                        null=True,
                        blank=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "roles",
                    models.ManyToManyField(to="limitless_acl.Role", null=True, blank=True),
                ),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "image",
                    models.ImageField(
                        max_length=255, upload_to=limitless.users.avatars.store.upload_to
                    ),
                ),
            ],
        ),
