...
class UserPostsView(ProfileView):
    template_name = "limitless/profile/posts.html"
...
class UserThreadsView(ProfileView):
    template_name = "limitless/profile/threads.html"
...
class UserFollowersView(ProfileView):
    template_name = "limitless/profile/followers.html"
...
class UserFollowsView(ProfileView):
    template_name = "limitless/profile/follows.html"
...
class UserProfileDetailsView(ProfileView):
    template_name = "limitless/profile/details.html"
...
class UserUsernameHistoryView(ProfileView):
    template_name = "limitless/profile/username_history.html"
...
class UserBanView(ProfileView):
    template_name = "limitless/profile/ban_details.html"
