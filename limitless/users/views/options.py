...
def index(request, *args, **kwargs):
    ...
    return render(request, "limitless/options/noscript.html")
...
def confirm_change_view(f):
    ...
    def decorator(request, token):
        try:
            ...
            return render(request, "limitless/options/credentials_error.html", status=400)
...
def confirm_email_change(request, token):
    ...
    return render(
        request,
        "limitless/options/credentials_changed.html",
