...
class AuthenticationForm(LimitLessAuthMixin, BaseAuthenticationForm):
    """
    Base class for authenticating users, Floppy-forms and
    LimitLess login field compliant
    """
...
class GetUserForm(LimitLessAuthMixin, forms.Form):
