...
logger = logging.getLogger("limitless.users.ProfileFields")
        ...
        logger.info(
            ...
            extra={
                "absolute_url": request.build_absolute_uri(
                    reverse(
                        "limitless:user-details", kwargs={"slug": user.slug, "pk": user.pk}
                    )
                )
            },
        )
...
profilefields = ProfileFields(settings.LIMITLESS_PROFILE_FIELDS)
