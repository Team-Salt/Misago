...
class UserSerializer(serializers.ModelSerializer, MutableFields):
    ...
    def get_api(self, obj):
        return {
            "index": reverse("limitless:api:user-detail", kwargs={"pk": obj.pk}),
            "follow": reverse("limitless:api:user-follow", kwargs={"pk": obj.pk}),
            "ban": reverse("limitless:api:user-ban", kwargs={"pk": obj.pk}),
            "details": reverse("limitless:api:user-details", kwargs={"pk": obj.pk}),
            "edit_details": reverse(
                "limitless:api:user-edit-details", kwargs={"pk": obj.pk}
            ),
            "moderate_avatar": reverse(
                "limitless:api:user-moderate-avatar", kwargs={"pk": obj.pk}
            ),
            "moderate_username": reverse(
                "limitless:api:user-moderate-username", kwargs={"pk": obj.pk}
            ),
            "delete": reverse("limitless:api:user-delete", kwargs={"pk": obj.pk}),
            "followers": reverse("limitless:api:user-followers", kwargs={"pk": obj.pk}),
            "follows": reverse("limitless:api:user-follows", kwargs={"pk": obj.pk}),
            "threads": reverse("limitless:api:user-threads", kwargs={"pk": obj.pk}),
            "posts": reverse("limitless:api:user-posts", kwargs={"pk": obj.pk}),
        }
