...
class LimitLessUsersConfig(AppConfig):
    name = "limitless.users"
    label = "limitless_users"
    verbose_name = "LimitLess Auth"
    ...
    def register_default_usercp_pages(self):
        ...
        usercp.add_section(
            link="limitless:usercp-change-forum-options",
            name=_("Forum options"),
            component="forum-options",
            icon="settings",
        )
        usercp.add_section(
            link="limitless:usercp-edit-details",
            name=_("Edit details"),
            component="edit-details",
            icon="person_outline",
        )
        usercp.add_section(
            link="limitless:usercp-change-username",
        ...
        usercp.add_section(
            link="limitless:usercp-change-email-password",
        ...
        usercp.add_section(
            link="limitless:usercp-download-data",
        ...
        usercp.add_section(
            link="limitless:usercp-delete-account",
    ...
    def register_default_users_list_pages(self):
        users_list.add_section(
            link="limitless:users-active-posters",
    ...
    def register_default_user_profile_pages(self):
        ...
        user_profile.add_section(
            link="limitless:user-posts", name=_("Posts"), icon="message", component="posts"
        )
        user_profile.add_section(
            link="limitless:user-threads",
            name=_("Threads"),
            icon="forum",
            component="threads",
        )
        user_profile.add_section(
            link="limitless:user-followers",
            name=_("Followers"),
            icon="favorite",
            component="followers",
        )
        user_profile.add_section(
            link="limitless:user-follows",
            name=_("Follows"),
            icon="favorite_border",
            component="follows",
        )
        user_profile.add_section(
            link="limitless:user-details",
            name=_("Details"),
            icon="person_outline",
            component="details",
        )
        user_profile.add_section(
            link="limitless:username-history",
