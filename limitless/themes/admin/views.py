...
class ThemeAdmin(generic.AdminBaseMixin):
    root_link = "limitless:admin:themes:index"
    model = Theme
    form_class = ThemeForm
    templates_dir = "limitless/admin/themes"
...
class ThemeAssetsAdmin(ThemeAdmin):
    ...
    def redirect_to_theme_assets(self, theme):
        return redirect("limitless:admin:themes:assets", pk=theme.pk)
...
class NewThemeCss(ThemeCssFormAdmin):
    ...
    def redirect_to_edit_form(self, theme, css):
        return redirect("limitless:admin:themes:edit-css-file", pk=theme.pk, css_pk=css.pk)
...
class NewThemeCssLink(ThemeCssFormAdmin):
    ...
    def redirect_to_edit_form(self, theme, css):
        return redirect("limitless:admin:themes:new-css-link", pk=theme.pk)
...
class EditThemeCssLink(NewThemeCssLink):
    ...
    def redirect_to_edit_form(self, theme, css):
        return redirect("limitless:admin:themes:edit-css-link", pk=theme.pk, css_pk=css.pk)
