...
def test_image_setting_can_be_set(admin_client, setting):
    with open(IMAGE, "rb") as image:
        admin_client.post(
            reverse("limitless:admin:settings:general:index"),
            {"forum_name": "LimitLess", "forum_address": "http://test.com", "logo": image},
        )
...
def test_omitting_setting_value_doesnt_remove_already_set_image(
    ...
    admin_client.post(
        reverse("limitless:admin:settings:general:index"),
        {"forum_name": "LimitLess", "forum_address": "http://test.com"},
    )
...
def test_set_image_can_be_deleted_by_extra_option(admin_client, setting_with_value):
    admin_client.post(
        reverse("limitless:admin:settings:general:index"),
        {"forum_name": "LimitLess", "forum_address": "http://test.com", "logo_delete": 1},
    )
