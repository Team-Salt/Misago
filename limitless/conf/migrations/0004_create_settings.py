...
default_settings = [
    ...
    {"setting": "forum_name", "dry_value": "LimitLess", "is_public": True},
    ...
    {"setting": "logo_text", "dry_value": "LimitLess", "is_public": True},
...
def create_settings(apps, _):
    ...
    Setting = apps.get_model("limitless_conf", "Setting")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("limitless_conf", "0003_simplify_models"),
        ("limitless_core", "0003_delete_cacheversion"),
        ("limitless_threads", "0012_set_dj_partial_indexes"),
        ("limitless_users", "0020_set_dj_partial_indexes"),
    ]
